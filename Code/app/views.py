...
__checkpoint_dir = 'D:/TFRECORD/data/checkpoint/'          # 模型文件路径
__code_to_chinese_file = 'D:/TFRECORD/data/app/train_model/code_word.pkl'  # 文字和对应的编码

__test_image_file  = 'D:/TFRECORD/data/app/image/pred1.png'  # 测试图片
__pred1_image_file = 'D:/TFRECORD/data/app/image/pred1.png'  # 预测结果1图片
__pred2_image_file = 'D:/TFRECORD/data/app/image/pred2.png'  # 预测结果2图片
__pred3_image_file = 'D:/TFRECORD/data/app/image/pred3.png'  # 预测结果3图片
...
def createImage(predword,imagepath):
    ...
    fonts = ImageFont.truetype("D:/TFRECORD/data/app/static/fonts/msyh.ttc",36,encoding='utf-8')
