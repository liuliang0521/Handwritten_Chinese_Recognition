...
class MyWindow(QWidget):
    ...
    def initUI(self):
        ...
        self.ansPredict_2 = 0
        self.ansPredict_3 = 0
        self.myFileStr = 'D:/TFRECORD/data/test/00999/223400.png'  # 这是inference的输入
        ...
        self.graphLabel.setFixedSize(200,200)
        ...
        self.ansLabel_1.setFixedSize(200,200)
        ...
        self.ansLabel_2.setFixedSize(200, 200)
        ...
        self.ansLabel_3.setFixedSize(200, 200)
    ...
    def showDialog(self):
        ...
        fname = QFileDialog.getOpenFileName(self, 'Open file', 'D:/TFRECORD/data/test/')
