...
tf.app.flags.DEFINE_string('log_dir', 'D:/TFRECORD/data/log/', 'the logging dir')
...
def get_label_dict():
    ...
    # f.close()
    with open('D:/TFRECORD/data/chinese_labels', 'r') as data_file:
...
def main(_):
    ...
    if FLAGS.mode == "train":
        ...
        name_list = get_file_list('D:/TFRECORD/data/test/00066/')
